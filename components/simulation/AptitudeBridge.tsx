        ...
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
            ...
            <AnimatePresence mode="wait">
                <motion.div 
                    ...
                    className="bg-black/40 border-2 border-white/10 rounded-[50px] p-12 w-full min-h-[600px] flex flex-col items-center justify-between relative overflow-hidden backdrop-blur-xl shadow-3xl"
                >
                    {/* Background Glows */}
